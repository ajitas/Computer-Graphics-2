...
Sphere::Sphere(void)
{
    ...
    vertices[0].x[0] = 1.0f; vertices[0].x[1] = 0.0f; vertices[0].x[2] = 0.0f;
    vertices[1].x[0] = -1.0f; vertices[1].x[1] = 0.0f; vertices[1].x[2] = 0.0f;
    vertices[2].x[0] = 0.0f; vertices[2].x[1] = 1.0f; vertices[2].x[2] = 0.0f;
    vertices[3].x[0] = 0.0f; vertices[3].x[1] = -1.0f; vertices[3].x[2] = 0.0f;
    vertices[4].x[0] = 0.0f; vertices[4].x[1] = 0.0f; vertices[4].x[2] = 1.0f;
    vertices[5].x[0] = 0.0f; vertices[5].x[1] = 0.0f; vertices[5].x[2] = -1.0f;
...
void
Sphere::Subdivide(unsigned int n)
{
    unsigned int    num_v;
    Vertex	    *new_v;
    unsigned int    num_e;
...
void
Sphere::Render(const bool smooth)
{
    double  	    l;
    unsigned int    i, j;
